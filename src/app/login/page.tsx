...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center -mt-16 px-4 py-24 relative overflow-hidden">
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-neon-violet/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md glass-panel rounded-3xl p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-outfit font-bold mb-2 text-gradient">Welcome Back</h1>
          <p className="text-muted-foreground text-center">
            Sign in to continue discovering your next gaming obsession.
          </p>
        </div>
